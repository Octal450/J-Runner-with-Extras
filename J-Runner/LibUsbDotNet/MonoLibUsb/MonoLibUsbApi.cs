...
namespace MonoLibUsb
{
    ...
    public static class MonoUsbApi
    {
        ...
        private static extern IntPtr OpenDeviceWithVidPidInternal([In]MonoUsbSessionHandle sessionHandle, int vendorID, int productID);
        ...
        public static MonoUsbDeviceHandle OpenDeviceWithVidPid([In]MonoUsbSessionHandle sessionHandle, int vendorID, int productID)
        {
