...
namespace MonoLibUsb.Transfer
{
    ...
    public class MonoUsbControlSetup
    {
        ...
        public short Value
        {
            get { return LHelper.HostEndianToLE16(Marshal.ReadInt16(handle, OfsValue)); }
            set { Marshal.WriteInt16(handle, OfsValue, LHelper.HostEndianToLE16(value)); }
        ...
        public short Index
        {
            get { return LHelper.HostEndianToLE16(Marshal.ReadInt16(handle, OfsIndex)); }
            set { Marshal.WriteInt16(handle, OfsIndex, LHelper.HostEndianToLE16(value)); }
        }
        /// <summary>
        ...
        public short Length
        {
            get { return LHelper.HostEndianToLE16(Marshal.ReadInt16(handle, OfsLength)); }
            set { Marshal.WriteInt16(handle, OfsLength, LHelper.HostEndianToLE16(value)); }
        }
