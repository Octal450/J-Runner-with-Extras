...
namespace JRunner
{
    public partial class Issues : Form
    {
        ...
        {
            Process.Start("https://github.com/J-Runner-With-Extras/J-Runner-with-Extras/issues");
        }

        private void CreateButton_Click(object sender, EventArgs e)
        {
            Process.Start("https://github.com/J-Runner-With-Extras/J-Runner-with-Extras/issues/new/choose");
        }
    }
}
