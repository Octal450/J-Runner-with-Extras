...
namespace JRunner.Nand
{
    class ntable
    {
        ...
        public static _nand[] Table = new _nand[]
        {
            ...
            new _nand(7373, "Elpis", 8498, 14699, 7, variables.hacktypes.glitch2, variables.ctypes[8]),
            new _nand(7375, "Elpis", 8498, 14699, 7, variables.hacktypes.glitch2, variables.ctypes[8]),
            ...
            new _nand(7377, "Elpis", 14717, 14719, 10, variables.hacktypes.glitch2, variables.ctypes[8]),
            ...
            new _nand(7378, "Elpis", 15572, variables.latest_dashboard, 12, variables.hacktypes.glitch2, variables.ctypes[8]),
