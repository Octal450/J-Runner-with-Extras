...
namespace JRunner.Nand
{
    class ntable
    {
        ...
        public static _patch[] patchTable = new _patch[]
        {
            ...
            new _patch("XLBoth", 0x0015D8EC, 0x00000001, 0x39401000, "Nand includes Both XL patches", "This NAND has Both XL patches applied, which only allows FATXplorer formatted storage devices to work\n\nYou must format your HDD at least once using FATXplorer, or you will get E69 on boot\n\nUSBs not formatted via FATXplorer, and all USB memory units, will no longer work\n\nIf you don't want this, generate an image without the Both XL checked under \"Patches/Drive Patches\"")
        };
